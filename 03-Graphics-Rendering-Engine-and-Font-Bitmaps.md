# 9.3 กลไกการเรนเดอร์กราฟิก, บิตแมปฟอนต์ และการจัดสัดส่วน UI บนจอความละเอียดจำกัด

---

## 9.3.1  ปรัชญาการออกแบบกราฟิกบนจอความละเอียดต่ำ (Low-Resolution UI Design)
...
การออกแบบส่วนต่อประสานผู้ใช้ (User Interface: UI) บนอุปกรณ์ขนาดจำกัดเช่นนี้ จึงต้องอาศัยหลักการเฉพาะตัว ในการทดลองนี้เราจะแบ่งหน้าจอออกเป็นส่วนต่าง เพื่อให้ใช้งานจอภาพที่จำกัดนี้ได้ ตามไดอะแกรมต่อไปนี้
...
1. **High Contrast & Visual Hierarchy:**
   - ใช้ความเปรียบต่างสูงสุด (ขาวตัดดำสนิท) เพื่อให้ผู้ใช้งานมองเห็นได้ชัดเจนในระยะ 0.5 - 1.5 เมตร
...
2. **Zero-Overhead Memory Footprint:**
   ...
   - แต่บนชิปคอนโทรลเลอร์ขนาดเล็ก สถาปัตยกรรมแบบ **1-bit per pixel** ใช้แรมของ ESP32 เพียง **1,024 ไบต์ (1 KB)** ทำให้เหลือแรมสำหรับ FreeRTOS, Wi-Fi Stack, และการประมวลผลอื่นอย่างเพียงพอ

---

## 9.3.2 อัลกอริทึมการวาดรูปทรงเรขาคณิตพื้นฐาน (Graphic Primitives)
...
นักศึกษาสามารถออกแบบฟอนต์ใด ๆ ได้เอง แต่ต้องระวังไม่ให้รหัสฟอนต์ (ASCII) ไปทับฟอนต์มาตรฐาน มิฉะนั้นจะไม่สามารถใช้ฟอนต์มาตรฐานได้
