# บทเรียนที่ 9.4: สถาปัตยกรรมระบบ IoT วงปิด (Closed-Loop Pipeline) และการปรับเทียบเซนเซอร์ (Calibration)

---

## 1. แนวคิดสถาปัตยกรรม IoT วงปิดแบบครบวงจร (Full-Duplex Closed-Loop IoT)
...
## 2. ทฤษฎีและการสร้างแบบจำลองการปรับเทียบเซนเซอร์ (Calibration Mathematics)

### ปัญหาของเซนเซอร์แอนะล็อกและวงจร ADC
ตัวแปลงสัญญาณแอนะล็อกเป็นดิจิทัล (ADC) ของ ESP32 เป็นแบบ 12 บิต ให้ค่าตั้งแต่ $0$ ถึง $4095$  
แต่ในความเป็นจริง:
...
## 3. โครงสร้าง REST Minimal API บน Kestrel Web Server
